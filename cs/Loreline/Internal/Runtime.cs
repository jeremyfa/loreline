...
namespace Loreline.Internal.Lang {
	...
	public static object getField(global::Loreline.Internal.Lang.HxObject obj, string field, int fieldHash, bool throwErrors)
	{
		if (obj == null && !throwErrors) return null;
		return obj.__hx_getField(field, (fieldHash == 0) ? global::Loreline.Internal.Lang.FieldLookup.hash(field) : fieldHash, throwErrors, false, false);
	}

	public static double getField_f(global::Loreline.Internal.Lang.HxObject obj, string field, int fieldHash, bool throwErrors)
	{
		if (obj == null && !throwErrors) return 0.0;
		return obj.__hx_getField_f(field, (fieldHash == 0) ? global::Loreline.Internal.Lang.FieldLookup.hash(field) : fieldHash, throwErrors, false);
	}

	public static object setField(global::Loreline.Internal.Lang.HxObject obj, string field, int fieldHash, object value)
	{
		return obj.__hx_setField(field, (fieldHash == 0) ? global::Loreline.Internal.Lang.FieldLookup.hash(field) : fieldHash, value, false);
	}

	public static double setField_f(global::Loreline.Internal.Lang.HxObject obj, string field, int fieldHash, double value)
	{
		return obj.__hx_setField_f(field, (fieldHash == 0) ? global::Loreline.Internal.Lang.FieldLookup.hash(field) : fieldHash, value, false);
	}

	public static object callField(global::Loreline.Internal.Lang.HxObject obj, string field, int fieldHash, object[] args)
	{
		return obj.__hx_invokeField(field, (fieldHash == 0) ? global::Loreline.Internal.Lang.FieldLookup.hash(field) : fieldHash, args);
	}
		public Runtime() {
		}
		...
		public static object closure(object obj, int hash, string field) {
			return new global::Loreline.Internal.Lang.Closure(obj, field, hash);
		}
		...
		public static object plus(object v1, object v2) {
			if (( ( v1 is string ) || ( v2 is string ) )) {
				return global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Root.Std.@string(v1), global::Loreline.Internal.Root.Std.@string(v2));
			}
			...
			throw new global::System.ArgumentException(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat("Cannot dynamically add ", global::Loreline.Internal.Root.Std.@string(v1)), " and "), global::Loreline.Internal.Root.Std.@string(v2)));
		}
		...
		public static object slowGetField(object obj, string field, bool throwErrors) {
			...
			if (( t == null )) {
				...
				if (( ( t == ((global::System.Type) (typeof(string)) ) ) && ( field == "fromCharCode" ) )) {
					return new global::Loreline.Internal.Lang.Closure(typeof(global::Loreline.Internal.Lang.StringExt), field, 0);
				}
			...
			if (( f != null )) {
				return global::Loreline.Internal.Lang.Runtime.unbox(f.GetValue(((object) (obj) )));
			}
			else {
				...
				if (( prop == null )) {
					...
					if (( ( m as global::System.Array ).Length > 0 )) {
						return new global::Loreline.Internal.Lang.Closure(( (( obj != null )) ? (obj) : ((object) (t) ) ), field, 0);
					}
					else {
						if (t.IsCOMObject) {
							try {
						...
						if (throwErrors) {
							throw ((global::System.Exception) (global::Loreline.Internal.Exception.thrown(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat("Cannot access field \'", field), "\'."))) );
						}
						else {
							return null;
						}
				...
				return global::Loreline.Internal.Lang.Runtime.unbox(prop.GetValue(((object) (obj) ), default(object[])));
			}
		...
		public static object slowSetField(object obj, string field, object @value) {
			...
			global::System.Reflection.FieldInfo f = t.GetField(((string) (field) ), ((global::System.Reflection.BindingFlags) (bf) ));
			if (( f != null )) {
				if (f.FieldType.ToString().StartsWith("global::Loreline.Internal.Lang.Null")) {
					@value = global::Loreline.Internal.Lang.Runtime.mkNullable(@value, f.FieldType);
				}
				...
				if (( prop == null )) {
					...
					throw ((global::System.Exception) (global::Loreline.Internal.Exception.thrown(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat("Field \'", field), "\' not found for writing from Class "), global::Loreline.Internal.Root.Std.@string(t)))) );
				}
				
				if (prop.PropertyType.ToString().StartsWith("global::Loreline.Internal.Lang.Null")) {
					@value = global::Loreline.Internal.Lang.Runtime.mkNullable(@value, prop.PropertyType);
				}
		...
		public static object callMethod(object obj, global::System.Reflection.MethodBase[] methods, int methodLength, object[] args) {
			unchecked {
				if (( methodLength == 0 )) {
					throw ((global::System.Exception) (global::Loreline.Internal.Exception.thrown("No available methods")) );
				}
							...
							if (( ( @params as global::System.Array ).Length != length )) {
								...
								int crate = 0;
								{
									...
									while (( _g4 < _g5 )) {
										...
										string strParam = global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Root.Std.@string(param), "");
				...
				if (( methodLength == 0 )) {
					throw ((global::System.Exception) (global::Loreline.Internal.Exception.thrown(global::Loreline.Internal.Lang.Runtime.concat("Invalid calling parameters for method ", ( ((global::System.Reflection.MethodBase) (methods[0]) ) as global::System.Reflection.MemberInfo ).Name))) );
				}
				...
				if (( ((global::System.Reflection.MethodBase) (methods[0]) ).ContainsGenericParameters && ( ((global::System.Reflection.MethodBase) (methods[0]) ) is global::System.Reflection.MethodInfo ) )) {
					...
					return global::Loreline.Internal.Lang.Runtime.unbox(retg);
				}
				...
				if (( ( obj == null ) && ( m1 is global::System.Reflection.ConstructorInfo ) )) {
					...
					return global::Loreline.Internal.Lang.Runtime.unbox(ret);
				}
				...
				return global::Loreline.Internal.Lang.Runtime.unbox(ret1);
			}
		}
		
		
		public static object unbox(object dyn) {
			if (( ( dyn != null ) && (global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Root.Std.@string(dyn.GetType()), "")).StartsWith("global::Loreline.Internal.Lang.Null") )) {
				return ((object) (global::Loreline.Internal.Lang.Runtime.callField(dyn, "toDynamic", 1705629508, null)) );
			}
			else {
				return dyn;
			}
		...
		public static object slowCallField(object obj, string field, object[] args) {
			...
			if (( last == 0 )) {
				throw ((global::System.Exception) (global::Loreline.Internal.Exception.thrown(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat(global::Loreline.Internal.Lang.Runtime.concat("Method \"", field), "\" not found on type "), global::Loreline.Internal.Root.Std.@string(t)))) );
			}
			
			return global::Loreline.Internal.Lang.Runtime.callMethod(obj, mis, last, args);
		}
		...
		public static object callField(object obj, string field, int fieldHash, object[] args) {
			...
			return global::Loreline.Internal.Lang.Runtime.slowCallField(obj, field, args);
		}
		...
		public static object getField(object obj, string field, int fieldHash, bool throwErrors) {
			...
			return global::Loreline.Internal.Lang.Runtime.slowGetField(obj, field, throwErrors);
		}
		...
		public static double getField_f(object obj, string field, int fieldHash, bool throwErrors) {
			...
			return global::Loreline.Internal.Lang.Runtime.toDouble(global::Loreline.Internal.Lang.Runtime.slowGetField(obj, field, throwErrors));
		}
		...
		public static object setField(object obj, string field, int fieldHash, object @value) {
			...
			return global::Loreline.Internal.Lang.Runtime.slowSetField(obj, field, @value);
		}
		...
		public static double setField_f(object obj, string field, int fieldHash, double @value) {
			...
			return global::Loreline.Internal.Lang.Runtime.toDouble(global::Loreline.Internal.Lang.Runtime.slowSetField(obj, field, @value));
		}
		...
		public static string toString(object obj) {
			...
			if (( obj is bool )) {
				if (global::Loreline.Internal.Lang.Runtime.toBool((obj))) {
					return "true";
				}
				else {
					return "false";
