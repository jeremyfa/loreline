...
class Linc {
	 ...
	 * updated by the code, and native changes are dragged in automatically
	 * (except for header only changes)
	 */
	 ...
	 * That path is calculated from the calling file using the optional _relative_root.
	 */
